...
<RecoveryStage>:
    ...
    MoaStage:
        ...
        app.recover_state(f_unnamed, verify_name=False)
        ...
        app.root_stage = RecoveryStage()
        app.recover_state(f_named, verify_name=False)
        self.assertEqual(root.b.count, app.root_stage.b.count)
        self.assertEqual(root.b.finished, app.root_stage.b.finished)
        self.assertEqual(clean_stage.d.count, app.root_stage.d.count)
        self.assertEqual(clean_stage.d.finished, app.root_stage.d.finished)
        ...
        app.root_stage = RecoveryStage()
        app.recover_state(f_unnamed, recover_unnamed=True, verify_name=False)
        self.assertEqual(root.b.count, app.root_stage.b.count)
        self.assertEqual(root.b.finished, app.root_stage.b.finished)
        ...
        stage = RecoveryStage()
        app.recover_state(f_named, stage=stage, recover_unnamed=True,
                          verify_name=False)
